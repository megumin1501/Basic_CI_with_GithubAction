...
WebUI.click(findTestObject('Object Repository/Page_App/button_For Employers'))

WebUI.switchToWindowTitle('App')

WebUI.click(findTestObject('Object Repository/Page_App/a_Login'))

WebUI.setText(findTestObject('Object Repository/Page_App/input_Forgot password_form-input h-12 w-ful_e3bf66'), 'phamviet12092002@mail.com')
