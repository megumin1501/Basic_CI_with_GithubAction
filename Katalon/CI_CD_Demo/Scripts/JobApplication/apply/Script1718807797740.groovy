...
WebUI.setText(findTestObject('Object Repository/Page_App/input_All Cities_keyword'), 'java')

WebUI.click(findTestObject('Object Repository/Page_App/circle'))

WebUI.click(findTestObject('Object Repository/Page_App/button_Apply now'))

WebUI.click(findTestObject('Object Repository/Page_App/p_Posted on 3 days ago'))

WebUI.click(findTestObject('Object Repository/Page_App/a_Apply now'))

WebUI.click(findTestObject('Object Repository/Page_App/button_Send my CV'))
