...
WebUI.click(findTestObject('Object Repository/Page_App/span_Sign In with Google'))
...
WebUI.click(findTestObject('Object Repository/Page_Sign in - Google Accounts/div_window.wiz_progresswindow.wiz_progress(_942921'))
