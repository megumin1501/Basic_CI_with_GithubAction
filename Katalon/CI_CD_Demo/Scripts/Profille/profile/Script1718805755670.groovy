...
WebUI.click(findTestObject('Object Repository/Page_App/div_Profile  CVs'))

WebUI.click(findTestObject('Object Repository/Page_App/svg_Your personal link_lucide lucide-circle_9b41fb_1_2'))

WebUI.click(findTestObject('Object Repository/Page_App/div_My Jobs'))

WebUI.click(findTestObject('Object Repository/Page_App/svg_Your personal link_lucide lucide-circle_9b41fb_1_2'))

WebUI.click(findTestObject('Object Repository/Page_App/div_AI Match Invitation'))

WebUI.click(findTestObject('Object Repository/Page_App/div_Viet'))

WebUI.click(findTestObject('Object Repository/Page_App/div_Email Subscriptions'))
